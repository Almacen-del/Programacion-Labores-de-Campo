...
await build({ ...options, entryPoints: [path.join(root, '.private/desktop-baseline/packages/importer/src/parse-master.ts')], outfile: path.join(root, 'dist/desktop-reference.mjs') });
